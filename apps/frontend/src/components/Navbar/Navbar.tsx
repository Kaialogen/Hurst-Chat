  ...
  return (
    <nav className='bg-gray-900 text-white px-6 py-4 flex justify-between items-center shadow'>
      <div className='flex space-x-6 items-center'>
        <Link to='/' className='font-bold text-lg hover:text-blue-400 transition'>
          Hurst Chat
        </Link>
      </div>
      <div className='flex space-x-4 items-center' id='userbar'>
        {loggedIn ? (
          ...
          <>
            ...
            <Link to='/register' className='bg-gray-700 hover:bg-gray-800 text-white px-4 py-2 rounded transition'>
              Register
            </Link>
          </>
        )}
