import { HiHome, HiOutlineHashtag, HiUserGroup, HiBookmark } from 'react-icons/hi';

export default function NavigationBar() {
  return (
    <nav className='h-screen w-full bg-zinc-900 text-white flex flex-col py-8 shadow-lg'>
