export default function TermsPage() {
  return (
    <div className='flex justify-center p-4'>
      <div id='content' className='w-full max-w-3xl text-slate-700'>
        <h2 className='text-center text-2xl pt-6'>Terms and Conditions</h2>
        <p className='text-center pb-6'>Welcome to Hurstchat!</p>
        <h3 className=''>
          <strong>Introduction</strong>
        </h3>
        <p className='pb-6'>
          These terms and conditions outline the rules and regulations for the use of HurstChats Website, located at
          http://localhost:3000.
        </p>
        <p className='pb-6'>
          By accessing this website we assume you accept these terms and conditions. Do not continue to use Hurstchat if
        ...
        <p>
          We employ the use of cookies. By accessing Hurstchat, you agreed to use cookies in agreement with the
          HurstChats Privacy Policy.
        </p>
        <p>
        ...
        <p>
          Unless otherwise stated, HurstChat and/or its licensors own the intellectual property rights for all material
          on Hurstchat. All intellectual property rights are reserved. You may access this from Hurstchat for your own
        ...
        <p>
          ...
          areas of the website. HurstChat does not filter, edit, publish or review Comments prior to their presence on
          the website. Comments do not reflect the views and opinions of HurstChat,its agents and/or affiliates.
          Comments reflect the views and opinions of the person who post their views and opinions. To the extent
          permitted by applicable laws, HurstChat shall not be liable for the Comments or for any liability, damages or
          expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments
          on this website.
        </p>
        <p>
          HurstChat reserves the right to monitor all Comments and to remove any Comments which can be considered
        ...
        <p>
          You hereby grant HurstChat a non-exclusive license to use, reproduce, edit and authorize others to use,
        ...
        <p>
          ...
          HurstChat; and (d) the link is in the context of general resource information.
        </p>
        <p>
        ...
        <p>
          ...
          you must inform us by sending an e-mail to HurstChat. Please include your name, your organization name,
        ...
        <p>
          No use of HurstChats logo or other artwork will be allowed for linking absent a trademark license agreement.
        </p>
